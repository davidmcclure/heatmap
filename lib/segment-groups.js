...
var d3 = require('d3');
var AvatarGroups = require('./avatar-groups');
 ...
 */
var SegmentGroups = function(heatmap) {
  AvatarGroups.apply(this, arguments);
};
 ...
 * Inherit from Group.
 */
SegmentGroups.prototype = Object.create(AvatarGroups.prototype);
SegmentGroups.prototype.constructor = SegmentGroups;
 ...
 */
SegmentGroups.prototype._injectAvatars = function(name) {
  ...
  _.times(delimiters.length + 1, function(i) {
    ...
    var segment = new Segment(last, delimiter, source, target);
 ...
 * @param {String} name The name of the group.
 */
SegmentGroups.prototype._renderAvatars = function(name) {
