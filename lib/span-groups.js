 ...
 */
var SpanGroups = function(heatmap) {
 ...
 * Inherit from Group.
 */
SpanGroups.prototype = Object.create(AvatarGroups.prototype);
SpanGroups.prototype.constructor = SpanGroups;
 ...
 */
SpanGroups.prototype._injectAvatars = function(name) {
 ...
 * @param {String} name The name of the group.
 */
SpanGroups.prototype._renderAvatars = function(name) {
