 ...
 *
 * @param {Number} sourcePx The number of pixels on on the source.
 * @return {Number}
 */
 ...
 *
 * @param {Number} targetPx The number of pixels on on the target.
 * @return {Number}
 */
